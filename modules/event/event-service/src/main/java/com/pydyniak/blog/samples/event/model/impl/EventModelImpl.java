...
import com.pydyniak.blog.samples.event.model.EventModel;
...
public class EventModelImpl extends BaseModelImpl<Event> implements EventModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"content", Types.VARCHAR}, {"date_", Types.TIMESTAMP}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table Event_Event (mvccVersion LONG default 0 not null,uuid_ VARCHAR(75) null,eventId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,statusDate DATE null,title STRING null,content STRING null,date_ DATE null)";
	 ...
	 */
	@Deprecated
	public static final long DATE_COLUMN_BITMASK = 16L;
	...
	static {
		...
		attributeGetterFunctions.put("mvccVersion", Event::getMvccVersion);
		attributeSetterBiConsumers.put(
			"mvccVersion", (BiConsumer<Event, Long>)Event::setMvccVersion);
		...
		attributeGetterFunctions.put("content", Event::getContent);
		attributeSetterBiConsumers.put(
			"content", (BiConsumer<Event, String>)Event::setContent);
	...
	public Object clone() {
		...
		eventImpl.setMvccVersion(getMvccVersion());
		...
		eventImpl.setContent(getContent());
	...
	public Event cloneWithOriginalValues() {
		...
		eventImpl.setContent(this.<String>getColumnOriginalValue("content"));
		eventImpl.setDate(this.<Date>getColumnOriginalValue("date_"));
	...
	public CacheModel<Event> toCacheModel() {
		...
		eventCacheModel.mvccVersion = getMvccVersion();
		...
		eventCacheModel.content = getContent();

		String content = eventCacheModel.content;

		if ((content != null) && (content.length() == 0)) {
			eventCacheModel.content = null;
		}
	...
	static {
		...
		columnBitmasks.put("date_", 32768L);
