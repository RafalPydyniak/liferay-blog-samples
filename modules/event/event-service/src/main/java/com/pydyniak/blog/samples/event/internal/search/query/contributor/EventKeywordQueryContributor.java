...
public class EventKeywordQueryContributor implements KeywordQueryContributor{
    ...
    public void contribute(String keywords, BooleanQuery booleanQuery, KeywordQueryContributorHelper keywordQueryContributorHelper) {
        ...
        queryHelper.addSearchLocalizedTerm(booleanQuery, searchContext, Field.CONTENT, true);
    }
}
