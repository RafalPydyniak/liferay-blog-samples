 ...
 * <code>com.pydyniak.blog.samples.event.service.impl.EventLocalServiceImpl</code> and
...
public class EventLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.pydyniak.blog.samples.event.service.impl.EventLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Event addEvent(
			Map<java.util.Locale, String> title,
			Map<java.util.Locale, String> content, java.util.Date date,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().addEvent(title, content, date, serviceContext);
	}
