 ...
 */
public class OtherFakeEventCreatedMessageListener implements MessageListener {

    private static final Log LOG = LogFactoryUtil.getLog(OtherFakeEventCreatedMessageListener.class);
